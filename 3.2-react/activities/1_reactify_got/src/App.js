...
import './App.css';
import winterfell from './winterfell-1.jpg';
          ...
          <body bgimage={winterfell}>
              <div className="QuestionContainer">
                  ...
                  <div className="Question">
                      ...
                      <img className="Question-image" alt="an image! sorry blind people" src="https://i.imgur.com/NPTQ1Hv.jpg" />
                  ...
                  <div className="Question">
                      ...
                      <img className="Question-image" alt="an image! sorry blind people" src="https://i.imgur.com/zoTroXq.jpg" />
                  ...
                  <div className="Question">
                      ...
                      <img className="Question-image" alt="an image! sorry blind people" src="https://i.imgur.com/m0u5VrG.jpg" />
                  ...
                  <div className="Question">
                      ...
                      <img className="Question-image" alt="an image! sorry blind people" src="https://i.imgur.com/QUkikLL.jpg" />
                  ...
                  <div className="Question">
                      ...
                      <img className="Question-image" alt="an image! sorry blind people" src="https://i.imgur.com/opChkVP.jpg" />
