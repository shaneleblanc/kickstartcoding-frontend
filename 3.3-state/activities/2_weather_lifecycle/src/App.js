...
class App extends Component {
  ...
  componentDidMount = () => {
    ...
    let userState = localStorage.getItem('user-state');
    console.log('userstate:',userState);
    if(userState.location) this.setState({location: userState.location});
    this.onRefresh();
  }
  onRefresh = () => {
    ...
    fetch(url)
      ...
      .then(data => {
        ...
        localStorage.setItem('user-state', this.state);
      });
  }
  ...
  render() {
    ...
    return this.state.loading ? (<div className="loader">Loading...</div>) : (
